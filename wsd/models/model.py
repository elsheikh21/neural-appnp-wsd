...
class SimpleModel(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--synset_embeddings_path', type=str, default='data/embeddings/ares_synset_embeddings.txt')
        ...
        parser.add_argument('--language_model_min_learning_rate', type=float, default=1e-7)
